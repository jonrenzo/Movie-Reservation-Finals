            ...
            <form action="#" class="mb-0 mt-6 space-y-4 rounded-2xl p-4 shadow-2xl sm:p-6 lg:p-8 ">
                <div>
                    <label class="input flex items-center gap-2 shadow-lg border-none rounded-lg">
                        ...
                        <input type="text" class="grow border-none rounded-md font-poppins" name="username" placeholder="Username" />
                    </label>
                </div>
                ...
                <div class="pb-4">
                    <label class="input flex items-center gap-2 shadow-lg border-none rounded-lg">
                        ...
                        <input type="password" class="grow border-none font-poppins" name="password" placeholder="Password" />
                    </label>
                </div>
