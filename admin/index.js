window.addEventListener('load', function() {
        ...
        sidebarLinks.forEach(link => {
            link.classList.remove('bg-gray-100', 'dark:bg-neutral-700', 'dark:text-white');
        });
        ...
        sidebarLinks.forEach(link => {
            ...
            if (link.getAttribute('href') && link.getAttribute('href').includes(currentPage)) {
                ...
                // If link is inside an accordion, open the accordion
                const parentAccordion = link.closest('.hs-accordion');
                if (parentAccordion) {
    ...
    console.log('Preline loaded:', typeof HSAccordion !== 'undefined');

    if (typeof HSAccordion !== 'undefined') {
        HSAccordion.init();
        console.log('Accordion initialized');
    } else {
        console.error('HSAccordion not found');
    }
